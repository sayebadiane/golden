...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Encoder/Decoder.php';
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\EventSubscriber\\UserSubscriber' => ['privates', 'App\\EventSubscriber\\UserSubscriber', 'getUserSubscriberService', true],
        ...
        ]), [0 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 1 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 2 => [0 => [0 => 'prePersist'], 1 => 'App\\EventSubscriber\\UserSubscriber'], 3 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\BoissonTailleCommandeRepository' => ['privates', 'App\\Repository\\BoissonTailleCommandeRepository', 'getBoissonTailleCommandeRepositoryService', true],
            ...
            'App\\Repository\\BurgerCommandeRepository' => ['privates', 'App\\Repository\\BurgerCommandeRepository', 'getBurgerCommandeRepositoryService', true],
            'App\\Repository\\BurgerRepository' => ['privates', 'App\\Repository\\BurgerRepository', 'getBurgerRepositoryService', true],
            'App\\Repository\\CataloguesRepository' => ['privates', 'App\\Repository\\CataloguesRepository', 'getCataloguesRepositoryService', true],
            ...
            'App\\Repository\\ComplementsRepository' => ['privates', 'App\\Repository\\ComplementsRepository', 'getComplementsRepositoryService', true],
            ...
            'App\\Repository\\LivraissonRepository' => ['privates', 'App\\Repository\\LivraissonRepository', 'getLivraissonRepositoryService', true],
            'App\\Repository\\LivreurRepository' => ['privates', 'App\\Repository\\LivreurRepository', 'getLivreurRepositoryService', true],
            'App\\Repository\\MenuBoissonTailleCommandeRepository' => ['privates', 'App\\Repository\\MenuBoissonTailleCommandeRepository', 'getMenuBoissonTailleCommandeRepositoryService', true],
            'App\\Repository\\MenuBurgerRepository' => ['privates', 'App\\Repository\\MenuBurgerRepository', 'getMenuBurgerRepositoryService', true],
            'App\\Repository\\MenuCommandeRepository' => ['privates', 'App\\Repository\\MenuCommandeRepository', 'getMenuCommandeRepositoryService', true],
            'App\\Repository\\MenuPortionFriteRepository' => ['privates', 'App\\Repository\\MenuPortionFriteRepository', 'getMenuPortionFriteRepositoryService', true],
            ...
            'App\\Repository\\PortionFriteRepository' => ['privates', 'App\\Repository\\PortionFriteRepository', 'getPortionFriteRepositoryService', true],
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('0', [0 => #[\Closure(name: 'App\\EventSubscriber\\UserSubscriber')] function () {
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AsSu5DmcJp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KIAWzSRu-z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vmsA3cN3y4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gpBiWpFbMM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WjyC+mGulS', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2gGEIcmj1I', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LCzzxPik-q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 4 => ($this->privates['debug.security.voter.App\\Security\\Voter\\MenuVoter'] ?? $this->load('getMenuVoterService'));
            yield 5 => ($this->privates['debug.security.voter.App\\Security\\Voter\\UserVoter'] ?? $this->load('getUserVoterService'));
            yield 6 => ($this->privates['debug.security.voter.App\\Security\\Voter\\ZoneVoter'] ?? $this->load('getZoneVoterService'));
        }, 7), new \Symfony\Component\Security\Core\Authorization\Strategy\AffirmativeStrategy(false)));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.collection.pagination.items_per_page' => 7,
