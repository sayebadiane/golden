...
class getApiPlatform_Listener_View_WriteService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.listener.view.write'] = new \ApiPlatform\Core\EventListener\WriteListener(new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataPersister\TraceableChainDataPersister(new \ApiPlatform\Core\DataPersister\ChainDataPersister(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\DataPersister\\BurgerDataPersister'] ?? $container->load('getBurgerDataPersisterService'));
            yield 1 => ($container->privates['App\\DataPersister\\CommandeDataPersister'] ?? $container->load('getCommandeDataPersisterService'));
            yield 2 => ($container->privates['App\\DataPersister\\MenuDataPersister'] ?? $container->load('getMenuDataPersisterService'));
            yield 3 => ($container->privates['App\\DataPersister\\ProduitDataPersister'] ?? $container->load('getProduitDataPersisterService'));
