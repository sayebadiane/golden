...
class Boisson extends \App\Entity\Boisson implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Boisson' . "\0" . 'gestionnaire', '' . "\0" . 'App\\Entity\\Boisson' . "\0" . 'boissonTailles', 'id', 'nom', 'image', 'prix', 'etat'];
        }
     ...
     * {@inheritDoc}
     */
    public function setGestionnaire(?\App\Entity\Gestionnaire $gestionnaire): \App\Entity\Boisson
    {
