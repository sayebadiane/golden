...
class Burger extends \App\Entity\Burger implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Burger' . "\0" . 'gestionnaire', '' . "\0" . 'App\\Entity\\Burger' . "\0" . 'menuBurgers', '' . "\0" . 'App\\Entity\\Burger' . "\0" . 'burgerCommandes', 'id', 'nom', 'image', 'prix', 'etat'];
        }
     ...
     * {@inheritDoc}
     */
    public function setGestionnaire(?\App\Entity\Gestionnaire $gestionnaire): \App\Entity\Burger
    {
     ...
     * {@inheritDoc}
     */
    public function getBurgerCommandes(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBurgerCommandes', []);

        return parent::getBurgerCommandes();
    }

    /**
     * {@inheritDoc}
     */
    public function addBurgerCommande(\App\Entity\BurgerCommande $burgerCommande): \App\Entity\Burger
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addBurgerCommande', [$burgerCommande]);

        return parent::addBurgerCommande($burgerCommande);
    }

    /**
     * {@inheritDoc}
     */
    public function removeBurgerCommande(\App\Entity\BurgerCommande $burgerCommande): \App\Entity\Burger
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeBurgerCommande', [$burgerCommande]);

        return parent::removeBurgerCommande($burgerCommande);
    }
